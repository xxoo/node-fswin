export declare namespace DirWatcher {
...
export declare namespace StorageProperties {
...
// https://github.com/xxoo/node-fswin/wiki/convertPath
export function convertPath(pathToConvert: string, callback: (result: string | null) => void, isLong?: boolean): boolean;
export function convertPathSync(pathToConvert: string, isLong?: boolean): string | null;
export function convertPathAsync(pathToConvert: string, isLong?: boolean): Promise<string | null>;
...
// https://github.com/xxoo/node-fswin/wiki/ejectDrive
...
// https://github.com/xxoo/node-fswin/wiki/getAttributes
export function getAttributes(path: string, callback: (result: Attributes | null) => void): boolean;
export function getAttributesSync(path: string): Attributes | null;
export function getAttributesAsync(path: string): Promise<Attributes | null>;

// https://github.com/xxoo/node-fswin/wiki/getDeviceCapabilities
export function getDeviceCapabilities(id: string, callback: (result: DeviceCapabilities | null) => void): boolean;
export function getDeviceCapabilitiesSync(id: string): DeviceCapabilities | null;
export function getDeviceCapabilitiesAsync(id: string): Promise<DeviceCapabilities | null>;

// https://github.com/xxoo/node-fswin/wiki/getDriveDevice
export function getDriveDevice(letter: string, callback: (result: DriveDevice | null) => void): boolean;
export function getDriveDeviceSync(letter: string): DriveDevice | null;
export function getDriveDeviceAsync(letter: string): Promise<DriveDevice | null>;

// https://github.com/xxoo/node-fswin/wiki/getLogicalDriveList
...
export function getLogicalDriveListAsync(): Promise<LogicalDriveList>;

// https://github.com/xxoo/node-fswin/wiki/getStorageProperties
export function getStorageProperties(path: string, properties: StorageProperties.Properties, callback: (result: StorageProperties.RootObject | null) => void): boolean;
export function getStoragePropertiesSync(path: string, properties: StorageProperties.Properties): StorageProperties.RootObject | null;
export function getStoragePropertiesAsync(path: string, properties: StorageProperties.Properties): Promise<StorageProperties.RootObject | null>;

// https://github.com/xxoo/node-fswin/wiki/splitPath
export function splitPath(fullPath: string): SplitPath;

// https://github.com/xxoo/node-fswin/wiki/getVolumeInformation
export function getVolumeInformation(volume: string, callback: (result: VolumeInformation | null) => void): boolean;
export function getVolumeInformationSync(volume: string): VolumeInformation | null;
export function getVolumeInformationAsync(volume: string): Promise<VolumeInformation | null>;

// https://github.com/xxoo/node-fswin/wiki/getVolumeSpace
export function getVolumeSpace(volume: string, callback: (result: VolumeSpace | null) => void): boolean;
export function getVolumeSpaceSync(volume: string): VolumeSpace | null;
export function getVolumeSpaceAsync(volume: string): Promise<VolumeSpace | null>;

// https://github.com/xxoo/node-fswin/wiki/setAttributes
...
export function setAttributesAsync(path: string, attributes: SetAttributes): Promise<boolean>;

// https://github.com/xxoo/node-fswin/wiki/setVolumeLabel
export function setVolumeLabel(volume: string, label: string, callback: (succeeded: boolean) => void): boolean;
export function setVolumeLabelSync(volume: string, label: string): boolean;
export function setVolumeLabelAsync(volume: string, label: string): Promise<boolean>;

export namespace ntfs {
	// https://github.com/xxoo/node-fswin/wiki/getCompressedSize
	export function getCompressedSize(file: string, callback: (result: number | null) => void): boolean;
	export function getCompressedSizeSync(file: string): number | null;
	export function getCompressedSizeAsync(file: string): Promise<number | null>;

	// https://github.com/xxoo/node-fswin/wiki/setCompression
	export function setCompression(fileOrDir: string, callback: (succeeded: boolean) => void, compress?: boolean, create?: boolean): boolean;
	export function setCompressionSync(fileOrDir: string, compress?: boolean, create?: boolean): boolean;
	export function setCompressionAsync(fileOrDir: string, compress?: boolean, create?: boolean): Promise<boolean>;

	// https://github.com/xxoo/node-fswin/wiki/setShortName
	...
	export function setShortNameAsync(pathToSet: string, newShortName?: string): Promise<boolean>;

	// https://github.com/xxoo/node-fswin/wiki/setSparse
	...
	export function setSparseAsync(file: string, create?: boolean): Promise<boolean>;
}